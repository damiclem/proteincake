...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path',             type=str,   default='results/do_enrichment/2_architectures')
    parser.add_argument('--out_wordcloud',        type=str,   default='results/do_enrichment/2_architectures')
