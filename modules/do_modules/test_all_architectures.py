...
def test_architecture(module, pfam_id, in_path, background, out, out_wordcloud, bonferroni, p_value = 0.05, depth = 4):
    ...
    os.system("python {} --out_path {} --out_wordcloud {} --target_path {} --background_path {} --p_value {} --depth {} --bonferroni {}".
              format(module, OUT, OUT_WORDCLOUD, TARGET, background, p_value, depth, bonferroni))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bonferroni',                type=int,   default=0)
    ...
    for n, dataset in enumerate(datasets):
        if dataset[0] == 'P':
            print('STARTING ITERATION {}/{} on architecture {}'.format(n-1, len(datasets)-2, dataset))
