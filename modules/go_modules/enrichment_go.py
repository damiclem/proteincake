...
if __name__ == '__main__':
        ...
        parser.add_argument('--target_path',          type=str,   default='data/go/go_original.csv')
        parser.add_argument('--background_path',      type=str,   default='data/go/go.csv')
        ...
        ### DF1 and DF2
        target_go= pd.read_table(args.target_path,
                                 dtype={'entry_ac': str,
                                         args.col_name_go_id: str,
                                         args.col_name_descr: str})

        background_go= pd.read_table(args.background_path,
                                     dtype={'entry_ac': str,
                                            args.col_name_go_id: str,
                                            args.col_name_descr: str})

        # 3. Compute the enrichness
        enrich_result = enrich(df1=target_go,
                               df2=background_go,
                               ontology=ontology,
